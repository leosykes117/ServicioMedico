...
BEGIN
	BEGIN TRY
		INSERT INTO tbPacientes VALUES (@Nombre, @Apellidos, @Genero, @Edad, @Correo,@Tipo)
...
EXEC insAgregarPacientes 'Ariel','Sanchez Rodriguez',1,40,'ariel_uami@yahoo.com.mx',2,@Mensaje OUTPUT, @Retornado OUTPUT
